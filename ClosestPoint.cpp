...
using namespace std;
double FindCloestPoint(double* pSample, int nSizeOfArray, double target, double& nearest);
...
int main()
{
    ...
    diff = FindCloestPoint(pSample, nSizeOfArray, target, nearest);
    cout << "cloest point is " << nearest << " its diff is " << diff << endl;
}
